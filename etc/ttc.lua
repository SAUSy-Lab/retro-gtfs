...
access_tag_whitelist = { ["yes"] = true, ["motorcar"] = true, ["motor_vehicle"] = true, ["vehicle"] = true, ["permissive"] = true, ["designated"] = true, ["destination"] = true, ["psv"] = true }
access_tag_blacklist = { ["no"] = true, ["private"] = true, ["agricultural"] = true, ["forestry"] = true, ["emergency"] = true, ["delivery"] = true }
access_tag_restricted = { ["destination"] = true, ["delivery"] = true }
access_tags_hierarchy = { "psv", "bus", "motorcar", "motor_vehicle", "vehicle", "access" }
service_tag_restricted = { ["parking_aisle"] = true }
restriction_exception_tags = { "psv","TTC","ttc","bus","motorcar", "motor_vehicle", "vehicle" }
...
function way_function (way, result)
  ...
  if railway == 'tram' then
    result.speed = 20
    result.forward_speed = 20
    result.backward_speed = 20
    result.forward_mode = mode.driving
    result.backward_mode = mode.driving
    result.name = 'tram line'
    return
  end

  -- all else if is for highway
