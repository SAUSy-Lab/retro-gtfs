-- default OSRM car profile with modifications for public transit including
--		slower speeds on some roads,
-- 	routing on streetcar tracks and busways
-- 	
...
-- THIS FUNCTION IS MODIFIED TO PROCESS STREETCAR TRACKS
...
function process_way(profile, way, result)
  ...
  (not data.route or data.route == '') and (not data.railway or data.railway == '')
  then
    return
  end
